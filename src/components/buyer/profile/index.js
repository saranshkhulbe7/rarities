          ...
          <div className="hero-content flex-col gap-20 lg:flex-row-reverse">
            ...
            <div className="max-w-[850px]">
              ...
              <p className="py-6 text-ternary">
                As an antique collector, I find myself constantly on the hunt
                for unique and valuable pieces. I take great pleasure in
                discovering items with a rich history and story behind them, and
                my collection is a testament to my passion for preserving the
                past. Whether I'm scouring antique shops or browsing online
                auctions, my love for these timeless treasures never fades.
              </p>
                          ...
                          buyers[id]?.current_biddings?.map((bid_id) => {
                            return (
                              <tr>
                                ...
                                <td>
                                  {products[bids[bid_id]?.product_id]?.name}
                                  <br />
